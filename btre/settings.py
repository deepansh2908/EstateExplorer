...
SECRET_KEY = "django-insecure-aq#y+ls%z+(la=bv2v@l#kb7g6s4!+ph6l84^(fb%egnwr4w6%"
...
# any app we make has to be added here (like pages, listings, realtors, accounts app)
...
DATABASES = {
    "default": {
        ...
        # Engine - modified from sqlite database to postgresql database
        "ENGINE": "django.db.backends.postgresql",
        # modified the name of the database to btredb
        "NAME": "btredb",
        "USER": "postgres",
        "PASSWORD": "232902",
        "HOST": "localhost",
